      ...
      tabs: [
        {
          ...
          src: "assets/01.png",
          content:
            "对装船过程中的异常情况随时发现、随时处理，建立了公平、公正、公开的计量形象。",
        },
        {
          title: "模型制作",
          icon: "icon-gengduo",
          src: "assets/02.png",
          content:
            "解决了大通关背景下船舱静态计量模式偏差大、效率低的问题，实现了出口成油商检模式的创新。电子监管系统的应用，实现了反欺诈的功能，有效地挽回企业不必要的经济损失并加快了通关速度，体现了政府部门服务企业的高时效性，树立了良好的检验检疫形象。以往进行的船舱计量，由于多种原因，计量结果常会受到贸易关系人的质疑，而且由于检验现场的不可复现性，难以用有力的证据来解释。电子监控系统后，对装船过程中的异常情况随时发现、随时处理，建立了公平、公正、公开的计量形象。",
        },
        {
          title: "三维可视化功能",
          icon: "icon-gengduo",
